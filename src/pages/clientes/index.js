...
export default function Clientes() {
    ...
    const excluir = (e) => {
        ...
        if (confirm("Deseja realmente excluir o Produto " + clienteParaExcluir.nome)) {
    ...
    const salvar = () => {
        if (!cliente.email || !cliente.cpfOuCnpj) {
            Swal.fire({
                icon: 'error',
                text: 'OS campos Quantidade e Código de Barras obrigatórios.'
            });
    ...
    const atualizarClienteNoBackend = (cliente) => {
        clienteService.atualizar(cliente)
            .then(response => {
                ...
                Swal.fire({
                    icon: 'success',
                    title: `Produto ${cliente.nome}, foi atualizado com sucesso!`,
    ...
    const adicionarClienteNoBackend = (cliente) => {
        clienteService.adicionar(cliente)
            .then(response => {
                ...
                Swal.fire({
                    icon: 'success',
                    title: `Produto ${cliente.nome}, foi cadastrado com sucesso!`,
                    showConfirmButton: false,
                    timer: 6000
                })
            ...
            <div className="row">
                ...
                <div className="col-sm-3">
                    <button onClick={adicionar} id="btn-adicionar" className="btn btn-primary btn-sm " data-bs-toggle="modal"
                        data-bs-target="#modal-cliente">Adicionar novo Produto</button>
                    <a href="./">
                        <button className="btn btn-outline-primary btn-sm mr-3">Voltar</button>
                    </a>
                        ...
                        <tbody>
                            {clientes.map(cliente => (
                                <tr>
                                    ...
                                    <td>
                                        <button id={cliente.id} onClick={editar} className="btn btn-outline-primary btn-sm mr-3" data-bs-toggle="modal" data-bs-target="#modal-cliente">
                                            Editar
                                        </button>
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-10">
                                    <label for="nome" className="form-label">Descrição</label>
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-4">
                                    <label for="email" className="form-label">Quantidade</label>
                                ...
                                <div className="col-sm-2">
                                    <label for="telefone" className="form-label">Aplicação</label>
                                ...
                                <div className="col-sm-3">
                                    <label for="cpf" className="form-label">Código de Barras</label>
                        ...
                        <div className="modal-footer">
                            ...
                            <button id="btn-cancelar" type="button" className="btn btn-light btn-sm" data-bs-dismiss="modal" data-backdrop="static">Cancelar</button>
                        </div>
